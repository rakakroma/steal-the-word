...
export const wordInfoBlockStyles = css`
  ...
  * {
  ...
  .definition-selectable:has(input:disabled) {
    background-color: #d9d9d9;
  }
  .definition-selectable:has(input:checked) {
