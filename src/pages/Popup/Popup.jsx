...
import { Box, Chip, createTheme, Divider, IconButton, Link, Stack, Switch, ThemeProvider, Typography } from '@mui/material';
...
const Popup = () => {
  ...
  useEffect(() => {
    chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
      ...
      chrome.storage.local.get(['activate', 'floatingWindow', 'mouseTool'], (obj) => {
    ...
    <ThemeProvider theme={theme}>
      <Box className="App" sx={{ width: '220px' }}>
        <Box sx={{ m: '6px' }}>
          ...
          >
            <Grid  >
              <Typography variant='h6' sx={{ fontSize: '15px' }}>Options</Typography>
            </Grid>
            <Grid>
              <IconButton
                LinkComponent={'a'}
          ...
          >
            ...
            <Typography variant='body1' sx={{ pl: '2px' }}>{currentDomain}</Typography>
            <IconButton>
